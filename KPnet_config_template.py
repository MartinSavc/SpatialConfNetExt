...
imTestCnt = -1  # 132 or imCnt - imTrainCnt
...
caffe_root = '/home/gsedej/git/caffe-segnet-1804/'
...
landmark_symbolsFile = os.path.join(configFileDir, 'landmark_symbols.txt')

# paths in 2_caffe/
caffeDir = os.path.join(configFileDir, '2_caffe')
netProtoFile = os.path.join(caffeDir, 'Models', netProtoFileName)
netModelFile = os.path.join(caffeDir, '0_caffeResult', netModelFileName)
lossDir = os.path.join(caffeDir, '2_loss')
# numpy matricies results for resized images (used by caffe)
npysResizedDir = os.path.join(caffeDir, '3_npys_resized')
resMatrixResizedFile = os.path.join(npysResizedDir, 'resMatrix_resized.npy')
GTmatrixResizedFile = os.path.join(npysResizedDir, 'GTmatrix_resized.npy')
diffMatrixResizedFile = os.path.join(npysResizedDir, 'diffMatrix_resized.npy')
# actuall caffe output for each test image for each label
resLabelsDir = os.path.join(caffeDir, '7_resLabels')
...
testImagesFile = os.path.join(LMDBdir, 'test', 'files.txt')
trainImagesFile = os.path.join(LMDBdir, 'train', 'files.txt')
